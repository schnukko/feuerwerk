...
class PygView(object):
    ...
    def paint(self):
        ...
        self.cannona = Cannon(pos=v.Vec2d(20,20))
        self.cannonb = Cannon(pos=v.Vec2d(PygView.width-20,20))
        self.cannonc = Cannon(pos=v.Vec2d(20,PygView.height-20))
        self.cannond = Cannon(pos=v.Vec2d(PygView.width-20,PygView.height-20))
    ...
    def run(self):
        ...
        while running:
            ...
            vectordiff = self.cannona.pos - self.ball1.pos
            self.cannona.set_angle(-vectordiff.get_angle()-180)                                                
